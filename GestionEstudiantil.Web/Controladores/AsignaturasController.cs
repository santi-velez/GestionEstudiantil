...
namespace GestionEstudiantil.Web.Controladores
{
    public class AsignaturasController : Controller
    {
        ...
        public AsignaturasController(BaseDeDatosContexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Codigo,Creditos")] Asignatura asignatura)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Codigo,Creditos")] Asignatura asignatura)
        {
            if (id != asignatura.Id)
            {
                return NotFound();
